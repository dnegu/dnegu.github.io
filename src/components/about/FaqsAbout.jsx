...
const SkillsList = () => {
  ...
  return (
    <div className="flex flex-col items-center text-left mx-auto max-w-6xl px-4 mt-16">
      <div className="site-container w-full">
        <h2 className="text-4xl font-bold flex flex-col items-center gap-6 text-center whitespace-nowrap text-white md:flex-row md:items-center md:text-end">
          ...
          <span className="drop-shadow-[2px_2px_0_#7836cf]">Más Sobre Mí & Metodología</span>
        </h2>
          ...
          {Object.entries(skills).map(([category, items]) => (
            <li key={category} className="w-full">
              ...
              >
                ...
                >
                  <p className="text-sm text-gray-200 leading-relaxed">{skills[category]}</p>
                </div>
              </div>
            </li>
          ))}
